...
interface Respuesta {
  periodo: { nombre: string; escalaExigencia: number; seccion: { id: string } };
  resumenCurso: {
...
export default function AdminResultadosEvaluacionPage() {
  ...
  useEffect(() => {
    fetch(`/api/admin/evaluaciones/${id}/resultados`)
      .then((r) => r.json())
      .then(setDatos);
  }, [id]);
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="no-print flex flex-wrap items-center justify-between gap-3">
        <div>
          <VolverLink href={`/admin/secciones/${datos.periodo.seccion.id}`} texto="Volver a la sección" />
          <h1 className="mt-2 text-2xl font-bold">Panel de resultados</h1>
          <p className="mt-1 text-slate-600">
            Vista de solo lectura para el administrador: resultados por sección, equipo e individuo.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="card">
          <p className="text-sm text-slate-500">Nota promedio de la sección</p>
      ...
      <div className="card">
        <h2 className="font-semibold">Puntos críticos de la sección (indicadores más bajos)</h2>
      ...
      <div className="card">
        <h2 className="font-semibold">Perfil de la sección por criterio (auto / compañeros / docente)</h2>
